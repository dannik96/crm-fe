...
const PostStateTable = (props: any) => {
    ...
    return (
        <Stack direction={'column'} spacing={1}>
            ...
            {<AddLabelDialog onClose={() => setOpen(false)} open={open} name={'Post state'} onSave={(value) => createProjectState(value)} />}
            <MUIDataTable
                title={"Posts"}
                data={postStates}
                columns={labelTableColumns(updateData, deleteData, "posts", (id: any) => getIsDeletable(id))}
