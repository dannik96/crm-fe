...
import { PostTableColumns, PostTableData, PostTableOptions } from "@/data/headers/Posts";
    ...
    return (
        <Grid container padding={4} spacing={3}>
            ...
            <Grid item xs={8}>
                ...
                >
                    <PostTable data={PostTableData} columns={PostTableColumns} options={PostTableOptions}/>
                </Paper>
            </Grid>
        </Grid>);
}